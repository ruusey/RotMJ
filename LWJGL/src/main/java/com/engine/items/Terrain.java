...
public class Terrain {
	...
	/**
	 * A Terrain is composed by blocks, each block is a GameItem constructed from a
	 * HeightMap.
	 *
	 ...
	 * @param minY          The minimum y value, before scaling, of each terrain
	 *                      block
	 * @param maxY          The maximum y value, before scaling, of each terrain
	 *                      block
	 * @param heightMapFile
	 * @param textureFile
	 * @param textInc
